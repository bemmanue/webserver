...
private:
	...
	void		parseRequestLine(const std::string& request, size_t* i);
	void		parseMethod(const std::string& request, size_t* i);
	void		parseURI(const std::string& request, size_t* i);
	void		parseVersion(const std::string& request, size_t* i);
